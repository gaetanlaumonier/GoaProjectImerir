...
class ContentRangementViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if isLastPage {
            ...
            button.setupButtonDynamicSize(fontSize: 15)
            ...
            button.addTarget(self.parent?.parent!, action: #selector(RangementViewController.hideModal), for: .touchUpInside)
            ...
            view.addConstraints([
                ...
                NSLayoutConstraint(item: button, attribute: .bottomMargin, relatedBy: .equal, toItem: view, attribute: .bottom, multiplier: 1, constant: -15),
