...
class ContentConsoleViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if actualImage == "AlienMissile" || actualImage == "SpaceHeal" || actualImage == "SpaceBonusHD" {
...
//        GamesRulesView?.imageView.image = UIImage(named: actualImage)
        ...
        if isLastPage {
            ...
            button.addTarget(self.parent?.parent!, action: #selector(ConsoleViewController.hideModal), for: .touchUpInside)
